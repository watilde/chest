module.exports = function () {
  ...
  message += '    chest take <file>  Take specified config file from the chest into the project root\n';
  ...
  message += '    chest boost        Open and install\n';
  message += '    chest close        Remove symbolic links created by "open"\n';
  message += '    chest scripts      Show list of chest-run-scripts\n';
  message += '    chest run <script> Run chest-run-scripts\n';
  message += '    chest sync         Sync meta info name, description and version\n';
  console.log(message);
};
